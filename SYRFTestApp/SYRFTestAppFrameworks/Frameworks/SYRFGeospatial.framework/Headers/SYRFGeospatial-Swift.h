...
#ifndef SYRFGEOSPATIAL_SWIFT_H
#define SYRFGEOSPATIAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SYRFGeospatial",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14SYRFGeospatial20GeosEngineOneManager")
@interface GeosEngineOneManager : NSObject
/// Default initializer
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14SYRFGeospatial20GeosEngineTwoManager")
@interface GeosEngineTwoManager : NSObject
/// Default initializer
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
